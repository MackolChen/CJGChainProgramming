...
@interface CJGViewChain ()
@property (nonatomic, assign) NSInteger  tag;
@end
@implementation CJGViewChain
...
{
    return ^__kindof CJGViewChain *(CGFloat cornerRadius) {
        [self enumerateObjectsUsingBlock:^(UIView * _Nonnull obj) {
...
{
    return ^__kindof CJGViewChain *(CGFloat borderWidth, UIColor *borderColor) {
        [self enumerateObjectsUsingBlock:^(UIView * _Nonnull obj) {
...
{
    return ^ CJGViewChain *(CGSize shadowOffset, CGFloat shadowRadius, UIColor *shadowColor, CGFloat shadowOpacity) {
        [self enumerateObjectsUsingBlock:^(UIView * _Nonnull obj) {
...
@end
CJGCATEGORY_VIEW_IMPLEMENTATION(UIView, CJGViewChain)
...
@implementation CJGViewChain (Masonry)
