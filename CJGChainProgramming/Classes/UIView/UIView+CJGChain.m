...
#define CJGCATEGORY_ADDVIEW(method, ModelClass, ViewClass)\
...
#define CJGCATEGORY_ADDLAYER(method, ModelClass, LayerClass)\
...
@implementation UIView (CJGChain)
- (CGPoint)origin {
...
CJGCATEGORY_ADDVIEW(addScrollView, CJGScrollViewChain, UIScrollView);
CJGCATEGORY_ADDVIEW(addTextView, CJGTextViewChain, UITextView);
CJGCATEGORY_ADDVIEW(addTableView, CJGTableViewChain, UITableView);

- (CJGCollectionViewChain * (^)(NSInteger tag))addCollectionView
{
    return ^(NSInteger tag) {
        ...
        [self addSubview:view];
        CJGCollectionViewChain *chainModel = [[CJGCollectionViewChain alloc] initWithTag:tag andView:view modelClass:[UICollectionView class]];
        return chainModel;
    };
}

CJGCATEGORY_ADDLAYER(addLayer, CJGLayerChain, CALayer)
CJGCATEGORY_ADDLAYER(addShaperLayer, CJGShaperLayerChain, CAShapeLayer)
CJGCATEGORY_ADDLAYER(addEmiiterLayer, CJGEmiiterLayerChain, CAEmitterLayer)
CJGCATEGORY_ADDLAYER(addScrollLayer, CJGScrollLayerChain, CAScrollLayer)
CJGCATEGORY_ADDLAYER(addTextLayer, CJGTextLayerChain, CATextLayer)
CJGCATEGORY_ADDLAYER(addTiledLayer, CJGTiledLayerChain, CATiledLayer)
CJGCATEGORY_ADDLAYER(addTransFormLayer, CJGTransFormLayerChain, CATransformLayer)
CJGCATEGORY_ADDLAYER(addGradientLayer, CJGGradientLayerChain, CAGradientLayer)
CJGCATEGORY_ADDLAYER(addReplicatorLayer, CJGReplicatorLayerChain, CAReplicatorLayer)
#define CJGCATEGORY_ADDVIEW(method, ModelClass, ViewClass)\
- (ModelClass * (^)(NSInteger tag))method    \
{   \
    return ^(NSInteger tag) {      \
...
@end
#undef CJGCATEGORY_ADDVIEW
#undef CJGCATEGORY_ADDLAYER
