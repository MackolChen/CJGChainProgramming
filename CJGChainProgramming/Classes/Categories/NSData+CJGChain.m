...
#import "NSData+CJGChain.h"
#import "NSString+CJGChain.h"

#include <zlib.h>
@implementation NSData (CJGChain)
...
@end
#define CJGDATA_ENCRYTION(encryptionType, clas)\
\
...
#define CJGDATA_WITH_KEY(alg, key)\
\
...
- (NSData *)md2Data{
    ...
    CJGDATA_ENCRYTION(MD2, 0)
    
}

- (NSString *)md2String{
    CJGDATA_ENCRYTION(MD2, 1)
}
- (NSString *)md4String{
    CJGDATA_ENCRYTION(MD4, 1)
}

- (NSData *)md4Data{
    CJGDATA_ENCRYTION(MD4, 0)
}

- (NSString *)md5String{
    CJGDATA_ENCRYTION(MD5, 1)
}

- (NSData *)md5Data{
    CJGDATA_ENCRYTION(MD5, 0)
}

- (NSString *)sha1String{
    CJGDATA_ENCRYTION(SHA1, 1)
}

- (NSData *)sha1Data{
    CJGDATA_ENCRYTION(SHA1, 0)
}

- (NSString *)sha224String{
    CJGDATA_ENCRYTION(SHA224, 1)
}

- (NSData *)sha224Data{
    CJGDATA_ENCRYTION(SHA224, 0);
}

- (NSString *)sha256String{
    CJGDATA_ENCRYTION(SHA256, 1);
}

- (NSData *)sha256Data{
    CJGDATA_ENCRYTION(SHA256, 0);
}

- (NSString *)sha384String{
    CJGDATA_ENCRYTION(SHA384, 1);
}

- (NSData *)sha384Data{
    CJGDATA_ENCRYTION(SHA384, 0);
}

- (NSString *)sha512String{
    CJGDATA_ENCRYTION(SHA512, 1);
}

- (NSData *)sha512Data{
    CJGDATA_ENCRYTION(SHA512, 0);
}


- (NSString *)hmacMD5StringWithKey:(NSString *)key{
    CJGDATA_WITH_KEY(MD5, key)
}
