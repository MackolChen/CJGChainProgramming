//
//  NSDictionary+CJGChain.h
//  CJGChain
//
//  Created by maxl on 2018/10/17.
//  Copyright © 2018年 CJGChain. All rights reserved.
//

#import <Foundation/Foundation.h>
NS_ASSUME_NONNULL_BEGIN
@interface NSDictionary <__covariant KeyType, __covariant ObjectType> (CJGChain)
...
@end
#define CJGMUTABLEDICTION_PROPERTY @property (nonatomic, strong, readonly) NSMutableDictionary <KeyType, ObjectType> *
@interface NSMutableDictionary <KeyType, ObjectType> (CJGChain)
...
CJGMUTABLEDICTION_PROPERTY ( ^ addValueForKey)(ObjectType object, KeyType key);

CJGMUTABLEDICTION_PROPERTY ( ^ addValueForKeyWithDefault)(ObjectType value, KeyType key, ObjectType defaultValue);

CJGMUTABLEDICTION_PROPERTY ( ^ removeValueForKey)(KeyType key);
