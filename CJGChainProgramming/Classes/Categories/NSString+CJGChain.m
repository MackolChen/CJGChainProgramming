...
#import "NSNumber+CJGChain.h"
@implementation NSString (CJGChain)
...
#define CJGSTRINGHASH(method)\
return [[self utf8Data] method];

#define CJGSTRINGHASH_KEY(method,key)\
return [[self utf8Data] hmac##method##StringWithKey:key];

@implementation NSString (Hash)
- (NSString *)md2String{
    CJGSTRINGHASH(md2String)
}

- (NSString *)md4String{
    CJGSTRINGHASH(md4String)
}

- (NSString *)md5String{
    CJGSTRINGHASH(md5String)
}

- (NSString *)sha1String{
    CJGSTRINGHASH(sha1String)
}

- (NSString *)sha224String{
    CJGSTRINGHASH(sha224String)
}

- (NSString *)sha256String{
    CJGSTRINGHASH(sha256String)
}

- (NSString *)sha384String{
    CJGSTRINGHASH(sha384String)
}
...
- (NSString *)hmacMD5StringWithKey:(NSString *)key{
    CJGSTRINGHASH_KEY(MD5,key)
}

- (NSString *)hmacSHA1StringWithKey:(NSString *)key{
    CJGSTRINGHASH_KEY(SHA1,key)
}

- (NSString *)hmacSHA224StringWithKey:(NSString *)key{
    CJGSTRINGHASH_KEY(SHA224,key)
}

- (NSString *)hmacSHA256StringWithKey:(NSString *)key{
    CJGSTRINGHASH_KEY(SHA256,key)
}

- (NSString *)hmacSHA384StringWithKey:(NSString *)key{
    CJGSTRINGHASH_KEY(SHA384,key)
}

- (NSString *)hmacSHA512StringWithKey:(NSString *)key{
    CJGSTRINGHASH_KEY(SHA512,key)
}
@end
